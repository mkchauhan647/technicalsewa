                    ...
                    <div className="absolute left-0 w-full">
                      <div className=" max-w-[1280px] mx-auto px-[2px]">
                        <div className="flex flex-col">
                          ...
                          <h3 className="md:w-[66%] text-white leading-[1.5] tracking-[1px] md:text-[25px] text-[20px] font-bold">
                            {childService?.title}
                          </h3>
                        </div>
                        ...
                        <div className="flex flex-col mt-[11px]  md:gap-[14px] ">
                          <div className="flex items-center">
                            {childService && (
                              <div
                                className="flex flex-col gap-2 pb-4 text-justify text-[10px] md:text-[12px] text-white listpoint"
