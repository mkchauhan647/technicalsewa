          ...
          <div className="section-1 hidden md:block shadow-lg px-[100px] py-[50px] ">
            <div className="description mb-4 ">
              ...
              <p className="text-[#505056] border-b-[2px] border-[#ededed] text-[15px] leading-[24px] pb-2 font-normal mt-[17px] text-center ">
                ...
                broken microwave oven can create, as well as the need of getting
                it back in running condition. That's why, we provide quick,
                reliable, and long-lasting Microwave oven Repair and Services.
              </p>
            </div>
            <div className="flex flex-col gap-[31px] ">
              <div className="flex items-center gap-2 ">
                ...
                <div>
                  ...
                  <p className="text-[#505056] text-[15px] font-normal leading-[24px] mt-[6px]">
                    Technical Sewa Service supports online payments using eSewa,
              ...
              <div className="flex items-center gap-2 ">
                ...
                <div>
                  ...
                  <p className="text-[#505056] text-[15px] font-normal leading-[24px] mt-[6px]">
                    Technical Sewa offers a 30-day warranty on spare parts and a
          ...
          <div className="section2 hidden md:flex flex-col gap-[55px] mt-4 ">
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="text-[#505056] text-[16px] leading-[24px] font-normal ">
                ...
                Hisense are the popular brands that Technical Sewa normally
                deals with.
              </p>
            </div>
            <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-4 mb-[31px] ">
              ...
              <p className="text-[#505056] text-[16px] leading-[24px] font-normal ">
                ...
                well as moisture from the steam in the air, can combine with
                filth and oil to produce a bacteria-friendly environment.
              </p>
            </div>
          </div>
        </div>
