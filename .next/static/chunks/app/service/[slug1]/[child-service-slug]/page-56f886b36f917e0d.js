...
`,X=(e,t)=>{let a=e.includes("top")?1:-1,[s,l]=C()?["0%{opacity:0;} 100%{opacity:1;}","0%{opacity:1;} 100%{opacity:0;}"]:[K(a),Q(a)];return{animation:t?`${w(s)} 0.35s cubic-bezier(.21,1.02,.73,1) forwards`:`${w(l)} 0.4s forwards cubic-bezier(.06,.71,.55,1)`}},ee=i.memo(({toast:e,position:t,style:a,children:s})=>{let l=e.height?X(e.position||t||"top-center",e.visible):{opacity:0},r=i.createElement(G,{toast:e}),o=i.createElement(W,{...e.ariaProps},k(e.message,e));return i.createElement(V,{className:e.className,style:{...l,...a,...e.style}},"function"==typeof s?s({icon:r,message:o}):i.createElement(i.Fragment,null,r,o))});r=i.createElement,u.p=void 0,b=r,y=void 0,v=void 0;var et=({id:e,className:t,style:a,onHeightUpdate:s,children:l})=>{let r=i.useCallback(t=>{if(t){let a=()=>{s(e,t.getBoundingClientRect().height)};a(),new MutationObserver(a).observe(t,{subtree:!0,childList:!0,characterData:!0})}},[e,s]);return i.createElement("div",{ref:r,className:t,style:a},l)},ea=(e,t)=>{let a=e.includes("top"),s=e.includes("center")?{justifyContent:"center"}:e.includes("right")?{justifyContent:"flex-end"}:{};return{left:0,right:0,display:"flex",position:"absolute",transition:C()?void 0:"all 230ms cubic-bezier(.21,1.02,.73,1)",transform:`translateY(${t*(a?1:-1)}px)`,...a?{top:0}:{bottom:0},...s}},es=g`
  z-index: 9999;
  > * {
    pointer-events: auto;
  }
`,el=({reverseOrder:e,position:t="top-center",toastOptions:a,gutter:s,children:l,containerStyle:r,containerClassName:o})=>{let{toasts:n,handlers:d}=M(a);return i.createElement("div",{style:{position:"fixed",zIndex:9999,top:16,left:16,right:16,bottom:16,pointerEvents:"none",...r},className:o,onMouseEnter:d.startPause,onMouseLeave:d.endPause},n.map(a=>{let r=a.position||t,o=ea(r,d.calculateOffset(a,{reverseOrder:e,gutter:s,defaultPosition:t}));return i.createElement(et,{id:a.id,key:a.id,onHeightUpdate:d.updateHeight,className:a.visible?es:"",style:o},"custom"===a.type?k(a.message,a):l?l(a):i.createElement(ee,{toast:a,position:r}))}))},er=B}},function(e){e.O(0,[2775,5625,6680,3296,8166,1524,7269,8121,372,7441,9173,1656,7029,5383,381,7991,9253,5769,1744],function(){return e(e.s=734)}),_N_E=e.O()}]);