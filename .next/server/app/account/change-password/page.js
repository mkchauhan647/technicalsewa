...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 69549)), "/mnt/CC1CE4DE1CE4C494/Projects/supreme/technicalsewa/technicalsewa/app/account/change-password/page.tsx"],
...
'loading': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 24521)), "/mnt/CC1CE4DE1CE4C494/Projects/supreme/technicalsewa/technicalsewa/app/loading.tsx"],
    ...
    const pages = ["/mnt/CC1CE4DE1CE4C494/Projects/supreme/technicalsewa/technicalsewa/app/account/change-password/page.tsx"];
    
    const originalPathname = "/account/change-password/page"
    const __next_app__ = {
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 17300))
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ ChangePasswordForm)
/* harmony export */ });
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(56786);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _store_useAuthStore__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7586);
...
function ChangePasswordForm() {
    const { user, signout, isLoading, isAuthenticated } = (0,_store_useAuthStore__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z)();
    ...
    const handleChangePassword = async (e)=>{
        e.preventDefault();
        if (!isValidForm) {
            (0,react_hot_toast__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .ZP)("Please fill all the fields");
            return;
        }
        ...
        await axios__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z.post(`https://smartcare.com.np/techsewa/publiccontrol/changePassword`, data).then(({ data })=>{
            if ((!data?.status || data?.status === "False") && data?.msg) {
                (0,react_hot_toast__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .ZP)(`❌ ${data?.msg}`);
            } else if (data?.status === "Success") {
                (0,react_hot_toast__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .ZP)(`Password changed successfully!`);
                signout();
            ...
            children: [
                    ...
                    children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("p", {
                                ...
                                children: "Enter your old password to change password."
                            })
                        ]
                    })
                }),
                /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("form", {
                    ...
                    children: [
                        ...
                        input.old_password && input.old_password?.length < 6 && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                        ...
                        input.new_password && input.new_password?.length < 6 && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                            className: "px-4 py-1 my-1 text-orange-700 bg-orange-100 border-l-4 border-orange-500",
                            role: "alert",
                            children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("p", {
                                children: "Password must be at least 6 characters"
                        ...
                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("button", {
                            ...
                            className: "text-white text-[15px] leading-[18px] bg-primary font-normal rounded-[2px] w-full py-[15px] mt-[44px] disabled:bg-opacity-60 disabled:cursor-not-allowed",
                            children: "Change Password"
                        })
                    ]
                })
...
;// CONCATENATED MODULE: ./features/account/changePassword/index.tsx

const proxy = (0,module_proxy.createProxy)(String.raw`/mnt/CC1CE4DE1CE4C494/Projects/supreme/technicalsewa/technicalsewa/features/account/changePassword/index.tsx`)
...
/* harmony default export */ const changePassword = (__default__);
;// CONCATENATED MODULE: ./app/account/change-password/page.tsx
...
function ChangePasswordPage() {
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
        children: [
            ...
            /*#__PURE__*/ jsx_runtime_.jsx(changePassword, {})
        ]
    });
}
...
var __webpack_exports__ = __webpack_require__.X(0, [3763,3190,8641], () => (__webpack_exec__(86256)));
