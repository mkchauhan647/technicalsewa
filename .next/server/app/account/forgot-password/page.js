...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 74740)), "/mnt/CC1CE4DE1CE4C494/Projects/supreme/technicalsewa/technicalsewa/app/account/forgot-password/page.tsx"],
...
'loading': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 24521)), "/mnt/CC1CE4DE1CE4C494/Projects/supreme/technicalsewa/technicalsewa/app/loading.tsx"],
    ...
    const pages = ["/mnt/CC1CE4DE1CE4C494/Projects/supreme/technicalsewa/technicalsewa/app/account/forgot-password/page.tsx"];
    
    const originalPathname = "/account/forgot-password/page"
    const __next_app__ = {
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 73754))
...
function ForgotPasswordForm() {
    ...
    const [accountType, setAccountType] = (0,react__WEBPACK_IMPORTED_MODULE_3__.useState)("");
    ...
    const handleSignIn = async ()=>{
        ...
        await axios__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z.post(`https://smartcare.com.np/techsewa/publiccontrol/resetpassword`, data).then(({ data })=>{
            if ((!data?.status || data?.status === "False") && data?.msg) {
                (0,react_hot_toast__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .ZP)(`❌ ${data?.msg}`);
            } else if (data?.status === "Success") {
                (0,react_hot_toast__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .ZP)(data?.msg ?? `New password has been sent to your mobile number.`);
                push("/login");
            }
        });
    };
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
        className: "bg-white  pt-10 pb-[79px]",
        children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
            ...
            children: [
                    ...
                    children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                        ...
                        children: [
                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("h2", {
                                className: "text-xl leading-[19.5px] font-semibold mt-[12px]",
                                children: "Reset your password"
                            }),
                            accountType && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("p", {
                                className: "text-gray-500",
                                children: "Enter your registered phone number to reset password."
                            })
                        ]
                    })
                }),
                !accountType && /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                    className: "mt-5",
                    children: [
                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                            className: "mb-2 w-full border-2 border-b border-gray-300"
                        }),
                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("p", {
                            className: "",
                            children: "Please specify forgot password is for customer or technician"
                        }),
                        /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                            className: "py-2 max-md:space-y-2 md:space-x-2 md:flex",
                            children: [
                ...
                accountType && /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
                    children: [
                        ...
                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("button", {
                            ...
                            className: "text-white text-[15px] leading-[18px] bg-primary font-normal rounded-[2px] w-full py-[15px] mt-[44px]",
                            children: "Reset Password"
                        })
                    ]
                }),
                /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                    className: "flex items-center justify-center mt-[57px] mb-[10px] space-x-1",
                    children: [
                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("p", {
...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ ForgotPasswordPage),
...
;// CONCATENATED MODULE: ./features/account/ForgotPassword/index.tsx

const proxy = (0,module_proxy.createProxy)(String.raw`/mnt/CC1CE4DE1CE4C494/Projects/supreme/technicalsewa/technicalsewa/features/account/ForgotPassword/index.tsx`)
...
/* harmony default export */ const ForgotPassword = (__default__);
;// CONCATENATED MODULE: ./app/account/forgot-password/page.tsx
...
var __webpack_exports__ = __webpack_require__.X(0, [3763,3190,2735], () => (__webpack_exec__(99266)));
