...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 25681)), "/mnt/CC1CE4DE1CE4C494/Projects/supreme/technicalsewa/technicalsewa/app/partpurja/[slug]/page.tsx"],
...
'loading': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 24521)), "/mnt/CC1CE4DE1CE4C494/Projects/supreme/technicalsewa/technicalsewa/app/loading.tsx"],
    ...
    const pages = ["/mnt/CC1CE4DE1CE4C494/Projects/supreme/technicalsewa/technicalsewa/app/partpurja/[slug]/page.tsx"];
    
    const originalPathname = "/partpurja/[slug]/page"
    const __next_app__ = {
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 65785))
...
const PartPurjaSlug1 = ({ slug, data })=>{
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
        className: "pt-[20px] pb-[79px] max-w-[1280px] mx-auto  ",
        children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
            className: "sm:w-[60%] w-[80%]  mx-auto border-[2px] border-[#2591b2] rounded-lg flex flex-col gap-2 p-4 md:p-10 text-[14px] text-[#a6adbb] font-bold",
            children: [
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (PartPurjaSlug1);
...
;// CONCATENATED MODULE: ./components/pageHelperComponents.js/PartPurjaSlug1.tsx

const proxy = (0,module_proxy.createProxy)(String.raw`/mnt/CC1CE4DE1CE4C494/Projects/supreme/technicalsewa/technicalsewa/components/pageHelperComponents.js/PartPurjaSlug1.tsx`)
...
/* harmony default export */ const PartPurjaSlug1 = (__default__);
...
;// CONCATENATED MODULE: ./app/partpurja/[slug]/page.tsx
...
async function getData(id) {
    ...
    const res = await fetch(`${baseUrl/* baseUrl */.F}/techsewa/publiccontrol/publicmasterconfig/getfeaturedDetailsbyid`, {
        method: "POST",
        body: formData,
        headers: {
...
const page = async ({ params })=>{
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
        children: [
            ...
            /*#__PURE__*/ jsx_runtime_.jsx(PartPurjaSlug1, {
                slug: slug,
                data: data
            }),
...
/* harmony default export */ const _slug_page = (page);
async function generateMetadata({ params }) {
    ...
    if (seoExists) {
        return {
            title: `${seoExists ? seoContent?.page_title : "Part Purja | Technical sewa"} `,
            description: `${seoContent?.description}`,
            keywords: `${seoContent?.key_words}`,
            openGraph: {
                title: `${seoExists ? seoContent?.og_title : "Part Purja | Technical sewa"} `,
...
var __webpack_exports__ = __webpack_require__.X(0, [3763,3190,6893,6558,8641,7776,651], () => (__webpack_exec__(47781)));
