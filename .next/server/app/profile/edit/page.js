...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 58274)), "/mnt/CC1CE4DE1CE4C494/Projects/supreme/technicalsewa/technicalsewa/app/profile/edit/page.tsx"],
...
'loading': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 24521)), "/mnt/CC1CE4DE1CE4C494/Projects/supreme/technicalsewa/technicalsewa/app/loading.tsx"],
    ...
    const pages = ["/mnt/CC1CE4DE1CE4C494/Projects/supreme/technicalsewa/technicalsewa/app/profile/edit/page.tsx"];
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 57715))
...
/* harmony import */ var _features_loader__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(47023);
/* harmony import */ var _lib_api__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(21289);
...
/* harmony import */ var react_hot_toast__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(33518);
...
function EditProfile() {
    ...
    const { user } = (0,_store_useAuthStore__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z)();
    const [profileLoading, setProfileLoading] = (0,react__WEBPACK_IMPORTED_MODULE_5__.useState)(true);
    ...
    const [selectedPhoto, setSelectedPhoto] = (0,react__WEBPACK_IMPORTED_MODULE_5__.useState)("");
    // technician attachments
    const [selectedCertificate, setSelectedCertificate] = (0,react__WEBPACK_IMPORTED_MODULE_5__.useState)("");
    const [selectedContract, setSelectedContract] = (0,react__WEBPACK_IMPORTED_MODULE_5__.useState)("");
    const [selectedCitzn, setSelectedCitzn] = (0,react__WEBPACK_IMPORTED_MODULE_5__.useState)("");
    const getProfile = async ()=>{
        const fdata = new FormData();
        if (isTechnician) fdata.append("tech_id", `${user?.id}`);
        else fdata.append("id", `${user?.id}`);
        const { data } = await _lib_api__WEBPACK_IMPORTED_MODULE_2__/* .api */ .hi.post(`/techsewa/publiccontrol/${isTechnician ? "getTechnicianProfile" : "getCustomerProfile"}`, fdata);
        setFormData({
            ...isTechnician ? {
                id: user?.id,
                name: data.sc_name,
    ...
    const handleUpdateProfile = async (e)=>{
        ...
        try {
            ...
            if (user?.type === "Technician") {
                await _lib_api__WEBPACK_IMPORTED_MODULE_2__/* .api */ .hi.post("/techsewa/publiccontrol/updateTechnician", fdata);
            } else {
                await _lib_api__WEBPACK_IMPORTED_MODULE_2__/* .api */ .hi.post("/techsewa/publiccontrol/updateCustomer", fdata);
            }
            (0,react_hot_toast__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .ZP)("Profile data updated!");
            push("/profile");
        } catch (error) {
    ...
    const handleChangePhotoField = (e)=>{
        const file = e.target.files[0];
        setSelectedPhoto(file);
    };
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
        className: "container py-4 mx-auto mb-10 md:max-w-3xl lg:!max-w-4xl",
        children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
            className: "flex mb-2 space-x-3 space-y-2 max-md:flex-col max-md:!space-y-4 max-md:px-2",
            children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                className: "p-4 w-full rounded-sm border max-md:mt-3 max-sm:order-2 border-primary",
                children: [
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("h2", {
                        className: "text-2xl font-semibold",
                        children: "Update Profile"
                    }),
                    profileLoading && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_features_loader__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z, {}),
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                        ...
                        children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("form", {
                            ...
                            children: [
                                isTechnician ? /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
                                    children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                ...
                                isTechnician && /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
                                    children: [
                                        /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                            className: "col-span-6 sm:col-span-3",
                                            children: [
...
;// CONCATENATED MODULE: ./features/account/edit-profile/index.tsx

const proxy = (0,module_proxy.createProxy)(String.raw`/mnt/CC1CE4DE1CE4C494/Projects/supreme/technicalsewa/technicalsewa/features/account/edit-profile/index.tsx`)
...
/* harmony default export */ const edit_profile = (__default__);
;// CONCATENATED MODULE: ./app/profile/edit/page.tsx
...
const page = async ()=>{
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
        children: [
            ...
            /*#__PURE__*/ jsx_runtime_.jsx(edit_profile, {}),
            /*#__PURE__*/ jsx_runtime_.jsx(Footer/* default */.ZP, {})
        ]
    });
};
/* harmony default export */ const edit_page = (page);
...
var __webpack_exports__ = __webpack_require__.X(0, [3763,3190,6893,5824,7776,1289,7023], () => (__webpack_exec__(50459)));
