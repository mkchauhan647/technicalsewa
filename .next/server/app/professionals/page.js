...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 50294)), "/mnt/CC1CE4DE1CE4C494/Projects/supreme/technicalsewa/technicalsewa/app/professionals/page.tsx"],
...
'loading': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 24521)), "/mnt/CC1CE4DE1CE4C494/Projects/supreme/technicalsewa/technicalsewa/app/loading.tsx"],
    ...
    const pages = ["/mnt/CC1CE4DE1CE4C494/Projects/supreme/technicalsewa/technicalsewa/app/professionals/page.tsx"];
    
    const originalPathname = "/professionals/page"
    const __next_app__ = {
...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ components_ProfessionalsCardButton)
});
...
;// CONCATENATED MODULE: ./components/ProfessionalsCardModal.tsx
/* eslint-disable @next/next/no-img-element */ 


const ProfessionalsCardModal = ({ email, address, name, image })=>{
                    ...
                    /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                        ...
                        children: [
                            /*#__PURE__*/ jsx_runtime_.jsx("h3", {
                                className: "text-primary text-[18px] lg:text-[24px] font-bold",
                                children: name
                            }),
                            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ jsx_runtime_.jsx("div", {
                                        className: "p-0.5 rounded-md border border-primary",
                            ...
                            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ jsx_runtime_.jsx("p", {
                                        className: "text-[16px] text-primary px-2 py-1 border-[2px] border-[#2591b2] hover:text-white hover:bg-primary",
                                        children: "Ratings"
                                    }),
                                    /*#__PURE__*/ jsx_runtime_.jsx("p", {
                                        className: "text-[16px] text-primary  px-2 py-1 border-[2px] border-[#2591b2] hover:text-white hover:bg-primary",
...
/* harmony default export */ const components_ProfessionalsCardModal = (ProfessionalsCardModal);

;// CONCATENATED MODULE: ./components/ProfessionalsCardButton.tsx
/* __next_internal_client_entry_do_not_use__ default auto */ 


const ProfessionalsCardButton = ({ email, address, name, image })=>{
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        children: [
            ...
            show && /*#__PURE__*/ jsx_runtime_.jsx(components_ProfessionalsCardModal, {
                address: address,
                email: email,
                name: name,
                image: image
...
/* harmony default export */ const components_ProfessionalsCardButton = (ProfessionalsCardButton);
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ professionals_page),
...
const proxy = (0,module_proxy.createProxy)(String.raw`/mnt/CC1CE4DE1CE4C494/Projects/supreme/technicalsewa/technicalsewa/components/ProfessionalsCardButton.tsx`)
...
/* harmony default export */ const ProfessionalsCardButton = (__default__);
...
;// CONCATENATED MODULE: ./app/professionals/page.tsx
...
// professionals page
const page = async ()=>{
    const professionalsData = await (0,api/* fetchServerClient */.df)("/techsewa/publiccontrol/getTechnicianProfilePublic");
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx(Nav/* default */.ZP, {}),
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                className: "  pt-[20px] pb-[79px] max-w-[1280px]  mx-auto flex flex-col items-center justify-center",
                children: [
                    /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                        className: "px-2 md:p-0",
                        children: [
                            /*#__PURE__*/ jsx_runtime_.jsx("h2", {
                                className: "text-[32px] md:text-[31px] text-center md:text-left",
                                children: "Our Professionals"
                            }),
                            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                                className: "grid grid-cols-1 gap-5 px-2 py-4 md:grid-cols-3 md:py-8 md:px-0",
                                children: professionalsData.map((s, index)=>/*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ jsx_runtime_.jsx("h3", {
                                                        className: "text-primary text-[17px] font-bold",
                                                        children: s.sc_name
                                                    }),
                                                    /*#__PURE__*/ jsx_runtime_.jsx("div", {
                                                        className: "flex gap-1 text-[12px] text-primary flex-wrap",
                                                        children: s?.skill?.split(",")?.map((skill, i)=>/*#__PURE__*/ jsx_runtime_.jsx("button", {
                                                    ...
                                                    /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ jsx_runtime_.jsx(ProfessionalsCardButton, {
                                                                name: s.sc_name,
                        ...
                        children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ jsx_runtime_.jsx("p", {
                                            className: "md:text-[32px] text-[18px] text-[#a6adbb] font-semibold text-center md:text-left",
                                            children: "Download our App"
                                        }),
                                        /*#__PURE__*/ jsx_runtime_.jsx("p", {
                                            className: "text-[14px] md:text-[27px]",
                                            children: "Enter mobile number to get APP download Link"
                                        })
                                    ]
                                }),
                                /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                    className: "flex flex-1 px-2 md:p-0",
                                    children: [
                                        ...
                                        /*#__PURE__*/ jsx_runtime_.jsx("button", {
                                            className: "px-6 text-white rounded-r-md bg-primary md:px-10 md:py-4",
                                            children: "SEND"
                                        })
                                    ]
                                })
...
var __webpack_exports__ = __webpack_require__.X(0, [3763,3190,6893,6558,2175,2735,7776,651], () => (__webpack_exec__(50113)));
